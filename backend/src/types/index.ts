        ...
        const messageToPhotographers = [
          {
            "type": "flex",
            "altText": "คุณมีข้อเสนองานใหม่ !",
            "contents": JSON.parse(`{"type":"bubble","body":{"type":"box","layout":"vertical","contents":[{"type":"text","text":"ประกาศงาน #${job.jobNo}","weight":"bold","size":"sm","color":"#000000"},{"type":"text","text":"${job.jobName}","weight":"bold","size":"xxl","margin":"md","color":"#000000"},{"type":"text","text":"${job.guest && job.guest > 0 ? 'จำนวนแขก ' + job.guest + ' คน' : ''}","size":"md","color":"#000000","wrap":true,"margin":"sm"},{"type":"text","text":"${job.location}","size":"xs","color":"#000000","wrap":true,"margin":"sm"},{"type":"box","layout":"vertical","margin":"xxl","spacing":"sm","contents":[{"type":"text","text":"ระยะเวลา","weight":"bold","size":"sm","color":"#000000"},{"type":"box","layout":"horizontal","contents":[{"type":"text","text":"เริ่ม : ${moment(job.startJob).format('DD/MM/YYYY')}","size":"sm","color":"#000000","flex":0},{"type":"text","text":"${moment(job.startJob).format('HH:mm')} น.","size":"sm","color":"#000000","align":"end"}]},{"type":"box","layout":"horizontal","contents":[{"type":"text","text":"ถึง : ${moment(job.endJob).format('DD/MM/YYYY')}","size":"sm","color":"#000000","flex":0},{"type":"text","text":"${moment(job.endJob).format('HH:mm')} น.","size":"sm","color":"#000000","align":"end"}]},{"type":"text","text":"${jobStartBudget} - ${jobEndBudget} บาท / วัน","weight":"bold","size":"lg","margin":"lg","color":"#000000","align":"center"},{"type":"text","text":"กรุณารับงานภายใน ${moment(job.limit).format('DD/MM/YYYY')}","size":"sm","color":"#FF0000","flex":0,"align":"center"},{"type":"button","style":"primary","action":{"type":"uri","label":"รับงาน","uri":"https://liff.line.me/1654887993-95d05znD"},"margin":"md","color":"#013490"},{"type":"text","text":"ปฏิเสธงานนี้","size":"xs","color":"#000000","flex":0,"align":"center","margin":"lg","decoration":"underline"}]},{"type":"separator","margin":"xxl"},{"type":"text","text":"ดูข้อเสนอราคาต่ำสุดของงานนี้","weight":"regular","size":"xs","margin":"xl","color":"#013490","align":"center"}]},"styles":{"footer":{"separator":true}}}`)
          }
        ]
            ...
            let messageToCustomer = [
              {
                ...
                "contents": JSON.parse(`{ "type": "carousel", "contents": [ { "type": "bubble", "body": { "type": "box", "layout": "vertical", "contents": [ { "type": "box", "layout": "vertical", "contents": [ { "type": "text", "text": "ประกาศงาน #0001", "size": "sm" }, { "type": "text", "text": "มีช่างภาพรับงานคุณ", "size": "sm", "color": "#15B856" } ] }, { "type": "box", "layout": "vertical", "contents": [ { "type": "image", "url": "https://scdn.line-apps.com/n/channel_devcenter/img/fx/01_1_cafe.png" } ], "paddingTop": "10px", "paddingBottom": "10px" }, { "type": "text", "text": "Photographer Name", "size": "xxs", "align": "center" }, { "type": "text", "text": "รับที่ราคา 2,000 บาท/วัน", "align": "center", "weight": "bold", "margin": "md" }, { "type": "button", "action": { "type": "uri", "label": "เลือกช่างภาพคนนี้", "uri": "http://linecorp.com/" }, "margin": "lg", "color": "#316BBB", "style": "primary", "height": "sm" } ], "margin": "none" }, "footer": { "type": "box", "layout": "vertical", "contents": [ { "type": "button", "action": { "type": "uri", "label": "ดูข้อมูลเพิ่มเติม", "uri": "http://linecorp.com/" }, "style": "link", "height": "sm" } ], "paddingAll": "0px" }, "styles": { "footer": { "separator": true } } }, { "type": "bubble", "body": { "type": "box", "layout": "vertical", "contents": [ { "type": "image", "url": "https://scdn.line-apps.com/n/channel_devcenter/img/fx/01_1_cafe.png", "gravity": "top", "size": "full", "aspectMode": "cover", "aspectRatio": "7:8", "action": { "type": "uri", "label": "action", "uri": "http://linecorp.com/" } } ], "paddingAll": "0px" } } ] }`)
              }
            ]
            ...
            let messageToPhotographer = [
              {
                ...
                "contents": JSON.parse(`{ "type": "bubble", "body": { "type": "box", "layout": "vertical", "contents": [ { "type": "text", "text": "ประกาศงาน #${job.jobNo}", "size": "sm" }, { "type": "text", "text": "ยินดีด้วยลูกค้าสนใจจ้างคุณ", "color": "#15B856", "size": "lg", "margin": "xxl", "align": "center", "weight": "bold" }, { "type": "text", "text": "อ่านเงื่อนไขและกติกา", "size": "sm", "decoration": "underline", "action": { "type": "uri", "label": "action", "uri": "http://linecorp.com/" }, "margin": "md", "align": "center" }, { "type": "button", "action": { "type": "uri", "label": "ตกลงรับงาน", "uri": "http://linecorp.com/" }, "style": "primary", "color": "#316BBB", "margin": "xxl" }, { "type": "text", "text": "ยกเลิกงานนี้", "size": "sm", "decoration": "underline", "action": { "type": "uri", "label": "action", "uri": "http://linecorp.com/" }, "margin": "lg", "align": "center" } ] } }`)
              }
            ]
            ...
            let messageToPhotographer = [
              {
                ...
                "contents": JSON.parse(`{ "type": "bubble", "body": { "type": "box", "layout": "vertical", "contents": [ { "type": "text", "text": "ประกาศงาน #${job.jobNo}", "size": "sm" }, { "type": "text", "text": "ยืนยันรับงาน", "color": "#15B856", "size": "lg", "margin": "xxl", "align": "center", "weight": "bold" }, { "type": "text", "text": "กรุณารอรับเงินมัดจำ 50% จากระบบ เป็นจำนวนเงิน ${jobMapping?.price ? jobMapping?.price * 0.5 : 0} บาท ", "align": "center", "margin": "xxl", "wrap": true }, { "type": "text", "text": "*คุณสามารถยกเลิกงานได้ หากไม่ได้รับเงินมัดจำภายใน 24 ชม.", "size": "sm", "color": "#F36E0E", "align": "center", "margin": "xxl", "wrap": true }, { "type": "text", "text": "อ่านเงื่อนไขและกติกา", "size": "sm", "decoration": "underline", "action": { "type": "uri", "label": "action", "uri": "http://linecorp.com/" }, "margin": "lg", "align": "center" } ] } }`)
              }
            ]
            ...
            let messageToCustomer = [
              {
                ...
                "contents": JSON.parse(`{ "type": "bubble", "body": { "type": "box", "layout": "vertical", "contents": [ { "type": "text", "text": "ประกาศงาน #${job.jobNo}", "size": "sm" }, { "type": "text", "text": "ยืนยันการรับงานจากช่างภาพ", "color": "#15B856", "size": "lg", "margin": "xxl", "align": "center", "weight": "bold" }, { "type": "text", "text": "กรุณาโอนเงินมัดจำ เพื่อเริ่มงาน", "align": "center" }, { "type": "text", "text": "บช. 123456789", "align": "center", "margin": "xxl", "weight": "bold" }, { "type": "text", "text": "จำนวน ${jobMapping?.price ? jobMapping?.price * 0.5 : 0} บาท (50%)", "align": "center", "weight": "bold" }, { "type": "text", "text": "ธนาคารกสิกรไทย", "align": "center", "margin": "xxl" }, { "type": "text", "text": "บริษัท PhotographerHub จำกัด", "align": "center" }, { "type": "button", "action": { "type": "uri", "label": "ส่งหลักฐานการโอนเงิน", "uri": "http://linecorp.com/" }, "style": "primary", "color": "#316BBB", "margin": "xxl" }, { "type": "text", "text": "*ทีมงานจะอนุมัติการจ้างหลังจาก ตรวจสอบหลักฐานเรียบร้อยแล้ว", "size": "sm", "action": { "type": "uri", "label": "action", "uri": "http://linecorp.com/" }, "margin": "lg", "align": "center", "color": "#F36E0E", "wrap": true } ] } }`)
              }
            ]
